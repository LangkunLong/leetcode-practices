class Solution:
    def kSmallestPairs(self, nums1: List[int], nums2: List[int], k: int) -> List[List[int]]:
        ...
        # need to use heap, cannot use 2 pointers because will have to iteratively increase / decrease pointers, 
        # need to check all possible surrounding combinations, since given in order, can check next index 
        # similar to BFS approach: using heap (priority queue) and visited set
        import heapq
        min_sum = []
        res = []
